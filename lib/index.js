...
exports.allTypeLogsOptions = exports.dailyWarn = exports.dailyInfo = exports.dailyError = exports.dailyApiDetail = exports.monthlyWarn = exports.monthlyInfo = exports.monthlyError = exports.monthlyApiDetail = exports.createApiLogger = exports.logWarn = exports.logInfo = exports.logError = void 0;
var logWithColor_1 = require("./logWithColor");
var create_file_1 = require("./create.file");
var log_options_1 = require("./log.options");
Object.defineProperty(exports, "allTypeLogsOptions", { enumerable: true, get: function () { return log_options_1.allTypeLogsOptions; } });
...
Object.defineProperty(exports, "monthlyApiDetail", { enumerable: true, get: function () { return log_options_1.monthlyApiDetail; } });
Object.defineProperty(exports, "monthlyError", { enumerable: true, get: function () { return log_options_1.monthlyError; } });
Object.defineProperty(exports, "monthlyInfo", { enumerable: true, get: function () { return log_options_1.monthlyInfo; } });
Object.defineProperty(exports, "monthlyWarn", { enumerable: true, get: function () { return log_options_1.monthlyWarn; } });
function logError(msg, options) {
    if (options === void 0) { options = log_options_1.allTypeLogsOptions; }
    return __awaiter(this, void 0, void 0, function () {
        var logFileName, logMessage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logFileName = (0, create_file_1.getfileName)(options);
...
function logInfo(msg, options) {
    if (options === void 0) { options = log_options_1.allTypeLogsOptions; }
    return __awaiter(this, void 0, void 0, function () {
        var logPrefix, logExtension, logGrouping, logMessage, logFileName;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logPrefix = options.logPrefix, logExtension = options.logExtension, logGrouping = options.logGrouping;
...
function createApiLogger(req, startTime, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var logPrefix, logExtension, logGrouping, logData, clientIP, endTime, timeDifference, logEntry, logFileName, error_1, errorLogFileName, errorLogEntry;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logPrefix = options.logPrefix, logExtension = options.logExtension, logGrouping = options.logGrouping;
